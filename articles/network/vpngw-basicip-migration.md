---
title: "Basic SKU の Public IP アドレスを使用している Azure VPN Gateway のマイグレーションについて（Basic SKU VPN Gatewayは除く）"
...
<video src="About_the_Basic_Public_IP_Migration.mp4" controls = "true"></video>
...
![](./vpngw-basicip-migration/basic-or-standard.png)
...
![](./vpngw-basicip-migration/check-sku.png)
...
![](./vpngw-basicip-migration/migration-to-standardIP.png)
...
![](./vpngw-basicip-migration/prepare.png)

このステップの完了にはおおよそ 30 分程度かかりますが、本ステップ中に通信影響は発生しません。<BR>

![](./vpngw-basicip-migration/migration-to-standardIP-2.png)

準備が完了すると、次のステップである［Migrate］および［Abort］が表示されます。<BR>

![](./vpngw-basicip-migration/migrate-abort.png)
...
![](./vpngw-basicip-migration/vpn-client.png)
...
![](./vpngw-basicip-migration/migration.png)
...
![](./vpngw-basicip-migration/failed.png)
...
![](./vpngw-basicip-migration/traffic.png)
...
![](./vpngw-basicip-migration/commit.png)
...
![](./vpngw-basicip-migration/finish.png)
